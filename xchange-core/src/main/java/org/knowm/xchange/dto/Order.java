...
public abstract class Order implements Serializable {
	public final static BigDecimal  quantityMultiplier = BigDecimal.valueOf(100000000);
  ...
  public String toStringShort() {
	    ...
	    return originalAmount.scaleByPowerOfTen(8).toPlainString() +","+timestamp.getTime() +",";
	  }
  @Override
  public int hashCode() {
